...
if ($asas == 'cash') {
?>
<input type="number" name="cash" id="cash" placeholder="Cash" style="width: 268px; height:30px;  margin-bottom: 15px;"  required/><br>
<span id="cash-error" style="color:red;"></span>
<?php
}
?>
<button class="btn btn-success btn-block btn-large" style="width:267px;" onclick="validateForm()"><i class="icon icon-save icon-large"></i> Save</button>
</center>
...
function validateForm() {
    ...
    var cashError = document.getElementById("cash-error");
    if (cash < total) {
        cashError.innerHTML = "Cash is smaller than total!";
