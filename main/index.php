...
?>
	...
	<div class="contentheader">
			...
			<font style=" font:bold 44px 'Aleo'; text-shadow:1px 1px 25px #000; color:#fff;"><center>Joycee Pharmacy</center></font>
<div id="mainmain">
...
<?php
	...
	<div class="span2">
          <div class="well sidebar-nav">
              ...
              <li class="active"><a href="#"><i class="icon-dashboard icon-2x"></i> Dashboard </a></li> 
			<li><a href="sales.php?id=cash&invoice=<?php echo $finalcode ?>"><i class="icon-shopping-cart icon-2x"></i> Sales</a>  </li>             
			<li><a href="products.php"><i class="icon-list-alt icon-2x"></i> Products</a>                                     </li>            </li>
			<br><br><br><br><br><br>		
			<li>
			 <div class="hero-unit-clock">
